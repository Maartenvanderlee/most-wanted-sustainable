...
The balcony panel may well be the most democratic piece of the energy transition in existence, and it is no coincidence that it has topped the trend lists at Most Wanted Sustainable for months. A set of two panels, around 800 watt-peak combined, produces 600 to 700 kilowatt-hours a year in the Netherlands. That doesn't power a whole household, and nobody needs to pretend it does. What it does cover is precisely the consumption that never stops: the fridge, the router, the forest of chargers a family turns out to own these days. In carbon terms it saves 200 to 270 kilos of CO2 a year. The emissions from manufacturing the panels are paid off after about a year and a half; after that they run virtually clean for two decades.

Earth-shattering it is not. It is, however, more than most people will do for the climate this year, and it requires no bank, no roof of your own and no partner to plough through quotes. At most, a message to the landlord.
